...
function update_task(){
	...
	for (var i=0;i < dm_array.length;i++){
		...
		totaldownloadSpeed = Math.round(parseInt(totaldownloadSpeed)) / 1000;
		totaluploadSpeed = Math.round(parseInt(totaluploadSpeed)) / 1000;
		totaldownloadSpeed = totaldownloadSpeed.toFixed(1);
		totaluploadSpeed = totaluploadSpeed.toFixed(1);
